...
(function () {
  ...
  /** @ngInject */
  function ClassCreateCtrl($scope, $stateParams, localStorageService, $rootScope, $state, $uibModal, toastr, $translate, $Schoolarity, $SchoolClassGroup, $SchoolClass, $Student) {
    $scope.class = {};
    $scope.listGroup = [];
